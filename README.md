...
Run using runthrough.py _if using data provided here_. Run using testing.py _if using your own raw data of form seen in all_data.csv_. 

Running the methods find here requires that the following are installed in the environment:
- openCV
- matplotlib
- pandas
- numpy
